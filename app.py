                ...
                # Updated to use correct port (7090) and context path (/quizmaster_war)
                API_BASE_URL = "http://0.0.0.0:7090/quizmaster_war/api/quiz"
                SPRING_APP_URL = "http://0.0.0.0:7090/quizmaster_war"
                ...
                try:
                    ...
                    if repl_slug and repl_owner:
                        API_BASE_URL = f"https://{repl_slug}.{repl_owner}.repl.co/quizmaster_war/api/quiz"
                        SPRING_APP_URL = f"https://{repl_slug}.{repl_owner}.repl.co/quizmaster_war"
                ...
                if is_api_available():
                    ...
                    st.sidebar.info("Make sure the Spring Boot application is running on port 7090")
                ...
                1. **Access via URL**: The Spring Boot application is running on port 7090, which is directly accessible via Replit.
                ...
                if st.button("Test Spring Boot API Connection"):
                    try:
                        ...
                        st.info("Make sure the Spring Boot application is running on port 7090")
